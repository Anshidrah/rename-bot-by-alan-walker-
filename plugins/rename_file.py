...
@A_lan_walker.on_message(pyrogram.filters.command(["scaption"]))
...
@A_lan_walker.on_message(pyrogram.filters.command(["rename"]))
    ...
    if (" " in update.text) and (update.reply_to_message is not None):
        ...
        if the_real_download_location is not None:
            ...
            await bot.send_document(
                ...
                parse_mode = "html",
                reply_markup=InlineKeyboardMarkup([
                    [ InlineKeyboardButton(text="𝚂ᴜᴘᴘᴏʀᴛ 𝙲ʜᴀɴɴᴇʟ", url=f"https://t.me/you_too_can_be_a_designer")]
              ]), 
